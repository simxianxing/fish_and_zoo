...
public class loadmnist {
    ...
    public static void main(String[] args) throws Exception {
        File data = new ClassPathResource("aitest/mnist_784_csv.csv").getFile();
        ...
        TransformProcess tp = new TransformProcess.Builder(sc).build();
...
//        }
        ...
        DataNormalization  normalizer = NormalizerSerializer.getDefault().restore("D:/TrainingLabs-main/dl4j-labs/src/main/java/ai/certifai/Day/mnist.norm");
