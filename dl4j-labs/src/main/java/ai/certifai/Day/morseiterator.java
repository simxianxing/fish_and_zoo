...
public class morseiterator {
    ...
    public static void setup() throws IOException {
        log.info("Load data...");
        trainDir = Paths.get("D:\\TrainingLabs-main\\dl4j-labs\\src\\main\\resources\\morseData\\train");
        testDir = Paths.get("D:\\TrainingLabs-main\\dl4j-labs\\src\\main\\resources\\morseData\\test");
